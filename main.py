...
def submit_form():
    ...
    return template('top_level_component.tpl', title='Welcome', name=my_name, investor_types=investor_types, result=f"Here are some stocks we want to recomment to you {my_name} since you are a {investor_type} investor: {Advisor(my_name).recommend_stocks(investor_type)}")
